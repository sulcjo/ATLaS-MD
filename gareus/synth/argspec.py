...
def make_feedback_args(*, target_overlap: float = 0.30, round_index: int = 0,
    ...
    d = dict(
        ...
        # Must track _shim_cv1_legacy_names's fallback default (gareus/cli.py:734,
        # currently 0.15) - this harness exists to validate real adaptive behavior,
        # so a stale value here silently tests against a spacing production never uses.
        contact_adaptive_target_spacing=0.15,
