...
<p class="sub">Complete report · compiled 2026-09-08 · bank: <code>RUNS/chignolin_genpept_r7/final_implicit_survivor_seeds/</code>
...
<h2 id="data">2. Dataset and measurement definitions</h2>
...
<h2 id="anchors">3. Correctness anchors (including the OXT defect)</h2>
...
<h2 id="census">4. Contact-CV census — 298 descriptors</h2>
...
<h2 id="cv2">5. CV2: bank torsion PCA, residualization, dynamics tests</h2>
<ul>
...
<h2 id="maps">6. Pseudo-FES map figures (v2 family)</h2>
...
<h2 id="dmap">7. Diffusion maps on the bank</h2>
...
<h2 id="twonn">8. Intrinsic dimensionality (TwoNN)</h2>
...
<h2 id="fourier">9. Fourier analysis of dihedrals — three passes</h2>
...
<h2 id="turn">10. The physical turn axis of the residual CV2</h2>
...
<h2 id="pairs">11. Alternative orthogonal pairs — 60 combinations tested</h2>
<dl class="did">
<dt>What we did:</dt>
...
<h2 id="decision-rigor">12. Decision dynamics &amp; rigor pack (11 follow-on checks)</h2>
...
<h2 id="residual-context">13. The residual-to-contacts motion in context — mechanism &amp; thermodynamics</h2>
<dl class="did">
<dt>What we did:</dt>
...
<h2 id="rec">14. Final recommendation</h2>
...
<h2 id="files">15. Files, reproduction, limitations</h2>
...
<tr><td>.../CV2_DEEPDIVE.md, DIFFMAP.md, FOURIER.md, TURN_AXIS.md, ORTHOGONAL_PAIRS.md, RESIDUAL_THERM.md, DYNAMICS_VALIDATION.md, STEERABILITY_STABILITY.md, MI_STATES_ENERGY.md, RIGOR_HANDOFF.md, PLAIN_PC2_CV2.md</td><td>per-analysis notes</td></tr>
...
python GENPEPT_R7_CV_CENSUS_REPORT/scripts/genpept_r7_plain_pc2.py       # plain-PC2 workup, ~4 s</pre>
